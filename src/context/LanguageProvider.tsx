...
const translations: Record<AppLanguage, TranslationTree> = {
  ar: {
    ...
    home: {
      brand: 'المعراج', daily: 'منصة الأستاذ اليومية', heroTitle: 'كل ما تحتاجه في يومك المهني، في مكان واحد.', heroBody: 'محتوى عملي، موارد مجانية وأدوات تساعدك على التحضير وإدارة القسم بكفاءة أكبر.', explore: 'استكشف المحتوى', seeAll: 'عرض الكل', quickTitle: 'وصول سريع', quickCaption: 'اختصر الطريق إلى ما تحتاجه', videos: 'فيديوهات تعليمية', videosSub: 'شرح وأفكار جاهزة للقسم', tests: 'فروض واختبارات', testsSub: 'موارد مجانية ومنظمة', problems: 'مشاكل وحلول', problemsSub: 'حلول عملية لمواقف يومية', tips: 'نصائح للأستاذ', tipsSub: 'أفكار قصيرة قابلة للتطبيق', refresh: 'تحديث', newTitle: 'جديد المعراج', newCaption: 'أحدث ما نُشر للأساتذة', loadError: 'تعذر تحميل المحتوى', loadErrorText: 'تحقق من الاتصال ثم اضغط تحديث.', preparing: 'المحتوى قيد التجهيز', preparingText: 'سيظهر هنا أحدث المحتوى المجاني فور نشره من المعراج.', trusted: 'منصة تعليمية موثوقة', trustedText: 'المحتوى المجاني هنا منفصل عن منتجات المعراج المدفوعة، لضمان قيمة واضحة وآمنة للأستاذ.'
    },
    profile: {
...
export function LanguageProvider({ children }: PropsWithChildren) {
  ...
  useEffect(() => {
    AsyncStorage.getItem(STORAGE_KEY)
      .then((saved) => {
        const next: AppLanguage = saved === 'en' ? 'en' : 'ar';
